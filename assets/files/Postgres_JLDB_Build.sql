...
DROP TABLE IF EXISTS acctmanager CASCADE;
DROP TABLE IF EXISTS acctmanager2 CASCADE;
...
Referred INT,
Region CHAR(2),
  CONSTRAINT customers_customerNum_pk PRIMARY KEY(customerNum),
...
ShipCost DOUBLE PRECISION,
  CONSTRAINT orders_orderNum_pk PRIMARY KEY(orderNum),
  CONSTRAINT orders_customerNum_fk FOREIGN KEY (customerNum)
...
CREATE TABLE ORDERITEMS 
     ( OrderNum INT,
       ...
       PaidEach DOUBLE PRECISION NOT NULL,
       CONSTRAINT orderitems_pk PRIMARY KEY (orderNum, itemNum),
       CONSTRAINT orderitems_orderNum_fk FOREIGN KEY (orderNum)
...
(Gift  varchar(15), 
 Minretail DOUBLE PRECISION, 
 Maxretail DOUBLE PRECISION); 
